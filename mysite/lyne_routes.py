...
lyne = Blueprint('lyne', __name__, template_folder='templates',url_prefix='/lyne')

# Route pour afficher le formulaire d'inscription et valider les données en POST
@lyne.route('/', methods=['GET', 'POST'])
def kmyyindex():
    return render_template("lyneindex.html")

# Route pour afficher le formulaire d'inscription et valider les données en POST
@lyne.route('/register', methods=['GET', 'POST'])
def register():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('lyne.verif', email=email))

    return render_template('lyne_username.html')


@lyne.route('/verif', methods=['GET', 'POST'])
def verif():
    ...
    return render_template('lyneverif.html')

@lyne.route('/redirect', methods=['GET', 'POST'])
def redirect_url():
    # Handle POST request
    if request.method == 'POST':
...
@lyne.route('/message', methods=['GET', 'POST'])
def message():
    if request.method == 'POST':
